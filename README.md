# Awesome Ada [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
* [spark-by-example](https://github.com/tofgarion/spark-by-example) ⭐ 163 | 🐛 2 | 🌐 Ada | 📅 2022-08-16 - Collection of verified functions and data types in SPARK.
...
* [Ada 2022 Reference Card](https://github.com/bracke/AdaReferenceCard/releases) ⭐ 13 | 🐛 9 | 🌐 TeX | 📅 2024-07-14 - Reference Card / Cheatsheet of Ada Attributes, Aspects, Pragmas and Standard Library.
...
* [crate-of-the-year](https://github.com/AdaCore/Ada-SPARK-Crate-Of-The-Year) ⭐ 22 | 🐛 0 | 📅 2025-11-18 - Yearly prize for the best Alire crate in three categories: general, SPARK and embedded.
...
* [hac](https://github.com/zertovitch/hac) ⭐ 157 | 🐛 7 | 🌐 Ada | 📅 2026-01-31 - The HAC Ada Compiler - a small, quick Ada compiler fully in Ada.
* [byron](https://github.com/OneWingedShark/Byron) ⭐ 63 | 🐛 0 | 🌐 Ada | 📅 2020-05-16 - A community project to build an Ada compiler, toolchain, and IDE-system.
...
<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 490 | 🐛 52 | 🌐 Ada | 📅 2026-02-11
...
* [lea](https://github.com/zertovitch/lea) ⭐ 28 | 🐛 1 | 🌐 Ada | 📅 2026-02-06 - A Lightweight Editor for Ada, aims to provide an easy, script-world-like, "look & feel" for developing Ada projects of any size and level, while enabling access to full-scale development tools like GNAT. LEA includes HAC, the HAC Ada Compiler.

### Text Modes

* [doom-ada](https://github.com/tomekw/doom-ada) ⭐ 18 | 🐛 1 | 🌐 Emacs Lisp | 📅 2025-09-15 - Doom Emacs Ada language module with syntax highlighting, LSP and Alire support.
...
* [ob-ada-spark](https://github.com/rocher/ob-ada-spark/) ⭐ 8 | 🐛 1 | 🌐 Emacs Lisp | 📅 2022-11-14 - Ada/SPARK support for org-babel : Evaluate source code blocks with Gnu Emacs and org files.
...
* [alire](https://github.com/alire-project/alire) ⭐ 369 | 🐛 352 | 🌐 Ada | 📅 2026-02-06 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
* [synth](https://github.com/jrmarino/synth) ⭐ 267 | 🐛 18 | 🌐 Ada | 📅 2025-06-19 - Next D/Ports build tool for live systems (Alternative for Portmaster and Portupgrade tools).
* [gprbuild](https://github.com/AdaCore/gprbuild) ⭐ 79 | 🐛 35 | 🌐 Ada | 📅 2026-01-22 - Adacore multi-language software build tool.
* [aura](https://github.com/annexi-strayline/AURA) ⭐ 24 | 🐛 10 | 🌐 Ada | 📅 2025-07-16 - An integrated build and source/package management tool with a more hands-on versioning approach. Alternative to alire and gprbuild. Optimized for CI/CD pipelines.
* [ravenadm](https://github.com/jrmarino/ravenadm) ⭐ 21 | 🐛 12 | 🌐 Ada | 📅 2026-02-11 - Administration tool for Ravenports <http://www.ravenports.com>.
...
* [ada-actions](https://github.com/ada-actions/toolchain) ⭐ 21 | 🐛 4 | 🌐 JavaScript | 📅 2022-03-11 - Ada Toolchains for GitHub Actions.
...
* [cortex-gnat-rts](https://github.com/simonjwright/cortex-gnat-rts) ⭐ 78 | 🐛 7 | 🌐 Ada | 📅 2025-03-18 - This package includes GNAT Ada Run Time Systems (RTSs) based on FreeRTOS and targeted at boards with Cortex-M0, M3, -M4, -M4F MCUs.
* [adawebpack](https://github.com/godunko/adawebpack) ⭐ 75 | 🐛 4 | 🌐 Ada | 📅 2025-02-16 - GNAT RTL for WebAssembly and bindings for Web API.
* [bb-runtimes](https://github.com/AdaCore/bb-runtimes) ⭐ 69 | 🐛 5 | 🌐 Ada | 📅 2026-02-10 - GNAT bare metal board support package (BSP).
...
* [bare-bones](https://github.com/Lucretia/bare_bones) ⭐ 90 | 🐛 0 | 🌐 Ada | 📅 2016-11-20 - An Ada port of the [osdev.org](https://wiki.osdev.org/Ada_Bare_Bones) minimal 32-bit x86 kernel.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 439 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 30,903 | 🐛 11 | 🌐 C | 📅 2026-02-11).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 101 | 🐛 2 | 🌐 Nim | 📅 2026-02-12 - Roguelike in sky with a steampunk setting.
* [ada-gate](https://github.com/fastrgv/AdaGate) ⭐ 22 | 🐛 0 | 🌐 Ada | 📅 2026-02-11 - AdaGate is a first-person 3D sokoban puzzle game within a Stargate / Portal fantasy setting for Windows, OS-X and Linux.
...
* [gnatcoll-bindings](https://github.com/AdaCore/gnatcoll-bindings) ⭐ 16 | 🐛 7 | 🌐 Ada | 📅 2026-02-11 - This is the bindings module of the GNAT Components Collection.
* [gnatcoll-db](https://github.com/AdaCore/gnatcoll-db) ⭐ 14 | 🐛 46 | 🌐 C | 📅 2025-11-28 - This is the DB module of the GNAT Components Collection.
* [lace](https://github.com/charlie5/lace) ⭐ 12 | 🐛 0 | 🌐 Ada | 📅 2025-11-14 - A set of Ada components to allow 3D simulations, games and GUI's in Ada.
...
* [asap](https://github.com/annexi-strayline/ASAP) ⭐ 7 | 🐛 0 | 📅 2024-07-07 - A set of general libraries and thick bindings for use with the AURA package management/build tool. Includes TCP, TLS, HTTP, a high-performance JSON parser/generator, and a formally verified (SPARK) UTF-8 stream decoder.
...
* [poly-orb](https://github.com/AdaCore/PolyORB) ⭐ 23 | 🐛 4 | 🌐 Ada | 📅 2026-02-03 - PolyORB provides a uniform solution to build distributed applications relying either on middleware standards.

### Graphical User Interface

* [gtkada](https://github.com/AdaCore/gtkada) ⭐ 101 | 🐛 39 | 🌐 Ada | 📅 2026-01-27 - Ada graphical toolkit based on Gtk3 components.
* [ada-gui](https://github.com/jrcarter/Ada_GUI) ⭐ 44 | 🐛 1 | 🌐 Ada | 📅 2025-06-20 - GUI implemented on its own task, so it doesn't require that its client give up a thread of control. Derived from [gnoga].
* [gwindows](https://github.com/zertovitch/gwindows) ⭐ 25 | 🐛 3 | 🌐 Ada | 📅 2026-02-05 - GNU Ada Visual Interface.
* [imgui-ada](https://github.com/Cre8or/ImGui-Ada) ⭐ 6 | 🐛 2 | 🌐 C++ | 📅 2023-08-25 - Ada binding of the ImGui library.
* [adawebui](https://github.com/godunko/adawebui) ⭐ 1 | 🐛 1 | 🌐 Ada | 📅 2022-06-05 - GUI based on [adawebpack].
...
* [ada-doom-3](https://github.com/AdaDoom3/AdaDoom3) ⭐ 278 | 🐛 8 | 🌐 Ada | 📅 2023-03-29 - Id Software's Id-tech-4-BFG in the Ada programming language.
* [globe-3d](https://github.com/zertovitch/globe-3d) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2025-04-18 - GL Object Based Engine for 3D.
* [ada-ogl](https://github.com/JulianSchutsch/AdaOGL) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2015-12-23 - Ada OpenGL Framework.
* [engine-3d](https://github.com/zertovitch/engine-3d) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2026-01-23 - A 3D engine for DOS-talgics.
...
* [aws](https://github.com/AdaCore/aws) ⭐ 151 | 🐛 35 | 🌐 Ada | 📅 2026-01-27 - Ada Web Server is a complete framework to develop Web based applications in Ada.

<!--lint enable awesome-list-item-->

* [awa](https://github.com/stcarrez/ada-awa) ⭐ 106 | 🐛 5 | 🌐 Ada | 📅 2026-01-04 - Ada Web Application is a framework to build a Web Application in Ada 2012. The framework provides several ready to use and extendable modules that are common to many web application. This includes the login, authentication, users, permissions, managing comments, tags, votes, documents, images.
  * [ada-security](https://github.com/stcarrez/ada-security) ⭐ 23 | 🐛 2 | 🌐 Ada | 📅 2025-11-10 - OAuth 2.0 client and server framework to secure web applications.
  * [ada-wiki](https://github.com/stcarrez/ada-wiki) ⭐ 20 | 🐛 2 | 🌐 Ada | 📅 2025-12-16 - Ada Wiki is a small library that provides a Wiki engine.
  * [dynamo](https://github.com/stcarrez/dynamo) ⭐ 17 | 🐛 5 | 🌐 Ada | 📅 2026-01-04 - Code generator used to generate an Ada Web Application or database mappings from hibernate-like XML description, YAML doctrine model or UML models.
  * [ada-asf](https://github.com/stcarrez/ada-asf) ⭐ 14 | 🐛 2 | 🌐 Ada | 📅 2025-11-10 - Ada Server Faces allows to create web applications using the same pattern as the Java Server Faces (See JSR 252, JSR 314 and JSR 344).
  ...
  * [ada-servlet](https://github.com/stcarrez/ada-servlet) ⭐ 7 | 🐛 2 | 🌐 Ada | 📅 2025-11-29 - Ada Servlet allows to create web applications using the same pattern as the Java Servlet (See JSR 154, JSR 315).
...
* [matreshka](https://github.com/godunko/matreshka) ⭐ 10 | 🐛 3 | 🌐 Ada | 📅 2023-05-01 - Framework to develop information systems consisting of five major components: League, XML processor, Web framework, SQL access, and the Modeling framework.

[matreshka]: https://github.com/godunko/matreshka

### Unit Test, Testing

* [bbt](https://github.com/LionelDraghi/bbt) ⭐ 18 | 🐛 6 | 🌐 Ada | 📅 2026-02-03 - Simple tool to black box check the behavior of an executable through the command line.
* [aunit](https://github.com/AdaCore/aunit) ⭐ 11 | 🐛 17 | 🌐 Ada | 📅 2026-02-04 - Ada unit testing framework.
...
* [elogs](https://github.com/kevlar700/elogs) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2025-11-20 - Logging framework for embedded systems absent of runtime errors.
...
* [septum](https://github.com/pyjarrett/septum) ⭐ 396 | 🐛 15 | 🌐 Ada | 📅 2026-02-10 - An interactive context-based text search tool for searching large codebases.
* [powerjoular](https://github.com/joular/powerjoular) ⭐ 100 | 🐛 10 | 🌐 Ada | 📅 2025-10-20 - This tool allows monitoring power consumption of multiple platforms and processes.
...
* [spark-2014](https://github.com/AdaCore/spark2014/) ⭐ 295 | 🐛 4 | 🌐 Ada | 📅 2026-02-11 - SPARK formal verification toolset.
* [gnat-coverage](https://github.com/AdaCore/gnatcoverage) ⭐ 46 | 🐛 5 | 🌐 Ada | 📅 2026-02-12 - GNATcoverage is a tool to analyze and report program coverage.
...
* [record-flux](https://github.com/Componolit/RecordFlux) ⭐ 122 | 🐛 186 | 🌐 Ada | 📅 2026-01-07 - RecordFlux: Toolset for the formal specification of messages and the generation of verifiable binary parsers and message generators in SPARK.
* [ocarina](https://github.com/OpenAADL/ocarina) ⭐ 73 | 🐛 33 | 🌐 Ada | 📅 2022-03-23 - AADL model processor: mappings to Ada code; Petri Nets; scheduling tools (MAST, Cheddar); WCET; REAL.
...
* [ada-ml](https://github.com/rocher/AdaML) ⭐ 11 | 🐛 0 | 📅 2023-05-14 - Ada-tailored UML Modeling Language.
* [coldframe](https://github.com/simonjwright/coldframe) ⭐ 9 | 🐛 7 | 🌐 Ada | 📅 2023-10-04 - This tool generates Ada framework code and documentation from UML models.
...
* [ada-keystore](https://github.com/stcarrez/ada-keystore) ⭐ 36 | 🐛 4 | 🌐 Ada | 📅 2025-12-16 - Ada Keystore - protect your sensitive data with secure storage.

## Libraries

### Math

* [math-packages](https://github.com/jscparker/math_packages) ⭐ 27 | 🐛 0 | 🌐 Ada | 📅 2022-10-31 - Collection of basic math routines in Ada.
* [mathpaqs](https://github.com/zertovitch/mathpaqs) ⭐ 13 | 🐛 0 | 🌐 Ada | 📅 2026-02-06 - Collection of mathematical, 100% portable, packages in the Ada programming language.
* [geo-energy-math](https://github.com/pukpr/GeoEnergyMath) ⭐ 8 | 🐛 2 | 🌐 Ada | 📅 2024-03-07 - Software libraries for solving models described in Mathematical GeoEnergy (Wiley, 2018).
* [lalg](https://github.com/jhumphry/LALG) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2022-04-11 - Interface to dense linear algebra packages.
...
* [si\_units](https://github.com/HeisenbugLtd/si_units) ⭐ 9 | 🐛 1 | 🌐 Ada | 📅 2020-10-19 - Utility library to pretty print physical values in proper metric units.

### Algorithms, Containers and Protocols

* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 286 | 🐛 58 | 🌐 Ada | 📅 2026-02-03 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
* [pragmarc](https://github.com/jrcarter/PragmARC) ⭐ 35 | 🐛 0 | 🌐 Ada | 📅 2026-01-09 - PragmAda Reusable Components (PragmARCs) from PragmAda S/W Engineering.
* [ada-traits-containers](https://github.com/AdaCore/ada-traits-containers) ⭐ 34 | 🐛 1 | 🌐 Ada | 📅 2024-11-05 - Generic Ada Library for Algorithms and Containers.
...
* [ada-lsp](https://github.com/reznikmm/ada-lsp) ⭐ 11 | 🐛 0 | 🌐 Ada | 📅 2017-12-21 - Language Server Protocol for Ada.
* [ada-sodoku](https://github.com/frett27/Ada-Sodoku) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2023-08-06 - Small Library for Sodoku grid solving / finding.
* [ada-ga](https://github.com/frett27/Ada-GA) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2023-08-06 - Genetic Algorithm Implementation for Ada.
...
* [smart-pointers](https://github.com/alire-project/smart_pointers) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2018-06-10 - A package providing a reference-counted access type Smart\_Pointer.
...
* [simple-blockchain](https://github.com/tomekw/simple_blockchain) ⭐ 21 | 🐛 0 | 🌐 Ada | 📅 2025-09-11 - Simple blockchain in Ada.
...
* [agpl](https://github.com/mosteo/agpl) ⭐ 4 | 🐛 2 | 🌐 Ada | 📅 2025-01-16 - Ada General Purpose Library (Miscellaneous utilities, with a robotic flavor).
* [chests](https://github.com/JeremyGrosser/chests) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2025-10-15 - Bounded containers for embedded systems.

[ada-language-server]: https://github.com/AdaCore/ada_language_server

### Cryptography

* [spark-nacl](https://github.com/rod-chapman/SPARKNaCl) ⭐ 129 | 🐛 4 | 🌐 Ada | 📅 2025-03-17 - SPARK 2014 re-implementation of the TweetNaCl crypto library.
...
* [libkeccak](https://github.com/damaki/libkeccak) ⭐ 36 | 🐛 1 | 🌐 Ada | 📅 2023-10-19 - A SPARK implementation of the Keccak family of sponge functions and related constructions.
* [libsparkcrypto](https://github.com/Componolit/libsparkcrypto) ⚠️ Archived - A cryptographic library implemented in SPARK.
* [libsodium-ada](https://github.com/jrmarino/libsodium-ada) ⭐ 10 | 🐛 1 | 🌐 Ada | 📅 2016-07-18 - A secure cryptographic library (libsodium for Ada).
...
* [threefish](https://github.com/jrcarter/Threefish) ⭐ 6 | 🐛 0 | 🌐 Ada | 📅 2025-08-14 - Ada Implementation of the Threefish-256 Encryption Algorithm.
...
* [zip-ada](https://github.com/zertovitch/zip-ada) ⭐ 32 | 🐛 1 | 🌐 Ada | 📅 2026-02-02 - Programming library for dealing with the Zip compressed archive file format.
...
* [libadalang](https://github.com/AdaCore/libadalang/) ⭐ 163 | 🐛 21 | 🌐 Ada | 📅 2026-02-11 - Library for parsing and semantic analysis of Ada code. It is meant as a building block for integration into other tools (IDE, static analyzers, etc).
...
* [ada-pretty](https://github.com/reznikmm/ada-pretty) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2021-02-14 - Pretty printing library for Ada.
...
* [protobuf](https://github.com/reznikmm/protobuf) ⭐ 44 | 🐛 8 | 🌐 Ada | 📅 2026-01-31 - A Google Protocol Buffers implementation in Ada, using [matreshka].
* [ada-yaml](https://github.com/yaml/AdaYaml) ⭐ 44 | 🐛 5 | 🌐 Ada | 📅 2022-01-20 - Experimental YAML 1.3 implementation in Ada.
* [ada-toml](https://github.com/pmderodat/ada-toml) ⭐ 36 | 🐛 2 | 🌐 Ada | 📅 2025-07-16 - TOML parser for Ada.
* [xmlada](https://github.com/AdaCore/xmlada) ⭐ 29 | 🐛 8 | 🌐 Ada | 📅 2026-01-26 - The XML/Ada toolkit.
* [generic-image-decoder](https://github.com/zertovitch/gid) ⭐ 27 | 🐛 0 | 🌐 Ada | 📅 2026-01-05 - Multi-format image decoder library for Ada.
* [spark-xml](https://github.com/Componolit/SXML) ⚠️ Archived - A formally verified XML library in SPARK.
* [ada-pdf-writer](https://github.com/zertovitch/ada-pdf-writer) ⭐ 23 | 🐛 0 | 🌐 Ada | 📅 2026-02-03 - Ada package for producing easily and automatically PDF files, from an Ada program, with text, vector graphics, images (JPEG).
...
* [excel-writer](https://github.com/zertovitch/excel-writer) ⭐ 9 | 🐛 0 | 🌐 Ada | 📅 2025-11-17 - Create Excel files with basic formats.
...
* [ada-bin2asc](https://github.com/jhumphry/Ada_BinToAsc) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2016-06-23 - Various binary-to-ASCII codecs such as Base64.
...
* [zeromq-ada](https://github.com/persan/zeromq-Ada.git) ⭐ 42 | 🐛 1 | 🌐 Ada | 📅 2025-11-17 - Binding to the ZeroMQ comunications-library.
* [adasockets](https://github.com/samueltardieu/adasockets) ⚠️ Archived - IPv4 socket library (TCP, UDP, and multicast).
* [kafka-ada](https://github.com/Latence-Technologies/Kafka-Ada) ⭐ 14 | 🐛 4 | 🌐 Ada | 📅 2022-09-02 - Binding for the C librdkafka library, allows sending and receiving from a Kafka bus.
* [coap-spark](https://github.com/mgrojo/coap_spark) ⭐ 8 | 🐛 0 | 🌐 Ada | 📅 2025-12-28 - A formally verified implementation of CoAP, the Constrained Application Protocol.
...
* [template-parser](https://github.com/AdaCore/templates-parser) ⭐ 10 | 🐛 1 | 🌐 Ada | 📅 2026-01-09 - AWS templates engine.

[template-parser]: https://github.com/AdaCore/templates-parser

### Graphics and Multimedia

* [sdlada](https://github.com/Lucretia/sdlada) ⭐ 128 | 🐛 24 | 🌐 Ada | 📅 2025-07-24 - Ada 2012 bindings to SDL 2.
* [opengl-ada](https://github.com/flyx/OpenGLAda) ⭐ 102 | 🐛 3 | 🌐 Ada | 📅 2022-09-08 - Thick Ada binding for OpenGL and GLFW.
...
* [cuda](https://github.com/AdaCore/cuda) ⭐ 21 | 🐛 2 | 🌐 Ada | 📅 2024-09-10 - Support for CUDA (Compute Unified Device Architecture) from AdaCore.
* [opencl-ada](https://github.com/flyx/OpenCLAda) ⚠️ Archived - An Ada binding for the OpenCL host API.
* [ada-bfd](https://github.com/stcarrez/ada-bfd) ⭐ 8 | 🐛 0 | 🌐 Ada | 📅 2025-11-02 - An Ada binding for the GNU Binutils BFD library. It allows to read binary ELF, COFF files by using the GNU BFD.
...
* [ada-synthetizer](https://github.com/frett27/Ada-Synthetizer) ⭐ 20 | 🐛 1 | 🌐 Ada | 📅 2023-08-09 - Sound Synthetizer Library implemented in Ada.
...
* [ux-strings](https://github.com/Blady-Com/UXStrings) ⭐ 17 | 🐛 0 | 🌐 Ada | 📅 2025-09-04 - Unicode extended strings.
...
* [simple-logging](https://github.com/alire-project/simple_logging) ⭐ 4 | 🐛 1 | 🌐 Ada | 📅 2026-02-06 - Easy to use logging facilities for output to console in Ada programs.
...
* [wposix](https://github.com/AdaCore/wposix) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2026-01-09 - Ada Windows POSIX binding.
...
* [win32ada](https://github.com/AdaCore/win32ada) ⭐ 22 | 🐛 2 | 🌐 Ada | 📅 2026-02-03 - Ada API to the Windows library.
...
* [ada-lua](https://github.com/AdaCore/ada-lua) ⭐ 45 | 🐛 0 | 🌐 Ada | 📅 2023-12-11 - Ada binding for Lua.
* [tcl-ada-shell](https://github.com/simonjwright/tcladashell) ⭐ 11 | 🐛 2 | 🌐 Ada | 📅 2023-02-26 - Tcl Ada SHell (Tash) is an Ada binding to Tcl/Tk.
...
* [SweetAda](https://github.com/gabriele-galeotti/SweetAda) ⭐ 49 | 🐛 0 | 🌐 Ada | 📅 2026-02-11 - A lightweight development framework whose purpose is the implementation of Ada-based software systems. It supports a plethora or CPU architectures and development boards.
* [adamant](https://github.com/lasp/adamant) ⭐ 39 | 🐛 2 | 🌐 Ada | 📅 2026-02-03 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
* [libgfxinit](https://github.com/coreboot/libgfxinit) ⭐ 25 | 🐛 0 | 🌐 Ada | 📅 2025-12-20 - A graphics initialization (aka modesetting) library for embedded environments, implemented in SPARK.
...
* [ada-drivers-library](https://github.com/AdaCore/Ada_Drivers_Library) ⭐ 273 | 🐛 23 | 🌐 Ada | 📅 2026-01-04 - Ada drivers for various MCU and sensors.
...
* [ada-enet](https://github.com/stcarrez/ada-enet) ⭐ 24 | 🐛 4 | 🌐 Ada | 📅 2025-12-23 - Embedded network stack (Ethernet driver, IPv4, UDP, DNS, DHCP, NTP) for STM32F746 or STM32F769.
* [sensortile](https://github.com/morbos/STM32/tree/master/L/L476/sensortile) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2024-04-07 - This project shows how to initialize a SensorTile and how to send sensor data over BLE from a SensorTile to a suitable host.

### Libraries

* [ada-synth-lib](https://github.com/raph-amiard/ada-synth-lib) ⭐ 35 | 🐛 7 | 🌐 Ada | 📅 2020-05-31 - Simple audio synthesis library that can run on bareboard devices.
* [geste](https://github.com/Fabien-Chouteau/GESTE) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2020-01-29 - Sprite and tile 2D render engine designed to run on micro-controllers.
* [ada-time](https://github.com/Fabien-Chouteau/Ada_Time) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2015-11-12 - Ada binding for the Pebble Time smartwatch.
* [giza](https://github.com/Fabien-Chouteau/Giza) ⭐ 7 | 🐛 0 | 🌐 Ada | 📅 2017-04-22 - This library is trying to be a simple widget tool kit for embedded platforms.
* [stm32-ui](https://github.com/stcarrez/stm32-ui) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2018-12-02 - STM32 UI library and tools (graphs, images, 12 hour clock).
...
* [etherscope](https://github.com/stcarrez/etherscope) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2017-12-03 - Ethernet traffic monitor on a STM32F746 board.
...
* [railway-simulation](https://github.com/AdaCore/SPARK_Railway_Simulation_Demo) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2019-11-22 - Program simulating a railway network with trains, switches and signaling. The signaling system is proven with SPARK/Ada to ensure that trains cannot collide.
...
* [lunar-lander-rotation](https://github.com/AdaCore/Lunar_Lander_Rotation_Demo) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2020-07-16 - Program that interacts with the AdaFruit BNO055 breakout board in order to send orientation data to a host computer.

### Generators

* [svd2ada](https://github.com/AdaCore/svd2ada) ⭐ 71 | 🐛 19 | 🌐 Ada | 📅 2025-02-13 - An Ada binding generator from SVD descriptions for bare board ARM devices.
...
* [azip](https://github.com/zertovitch/azip) ⭐ 14 | 🐛 1 | 🌐 Ada | 📅 2026-02-02 - A free, portable Zip Archive Manager.
* [cbsg](https://github.com/zertovitch/cbsg) ⭐ 14 | 🐛 0 | 🌐 Ada | 📅 2025-12-02 - The Corporate Bullshit Generator.
* [texcad](https://github.com/zertovitch/texcad) ⭐ 6 | 🐛 0 | 🌐 Ada | 📅 2025-07-20 - A program for drawing or retouching {picture}s in LaTeX.
...
* [yass](https://github.com/yet-another-static-site-generator/yass) ⭐ 26 | 🐛 4 | 🌐 Ada | 📅 2025-09-05 - Yet Another Static Site Generator (like Jekyll or Hugo).
* [wasabee](https://github.com/zertovitch/wasabee) ⭐ 13 | 🐛 0 | 🌐 Ada | 📅 2026-01-17 - A Web browser with safety focus.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,749 | 🐛 366 | 🌐 VHDL | 📅 2026-02-08 - VHDL 2008/93/87 simulator.
...
* [parallel-sim](https://github.com/JulianSchutsch/ParallelSim) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2013-06-15 - Distributed Simulation of Transport Networks.

### Generators and Translators

* [pascal-to-ada](https://github.com/zertovitch/pascal-to-ada) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2024-10-20 - A Pascal to Ada translator.
  * [tp7-ada-gnoga](https://github.com/Blady-Com/tp7ada-gnoga) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2022-02-14 - Implementation of Turbo Pascal 7.0 units with [gnoga].
...
* [winforms2gtk](https://github.com/fdesp87/winforms2gtk) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2026-01-25 - Helper conversor of Visual Basic Microsoft Windows Forms applications to Gtk and Ada.
...
* [dashera](https://github.com/SMerrony/dashera) ⭐ 37 | 🐛 1 | 🌐 Ada | 📅 2024-05-20 - Data General DASHER terminal emulator using [gtkada].
* [a-shell](https://github.com/charlie5/aShell) ⭐ 16 | 🐛 1 | 🌐 Ada | 📅 2025-11-04 - A component to aid in writing shell-like applications in Ada.
...
* [whitakers-words](https://github.com/mk270/whitakers-words) ⭐ 306 | 🐛 50 | 🌐 Ada | 📅 2025-01-21 - William Whitaker's WORDS, a Latin dictionary.
* [ada-chess](https://github.com/adachess/AdaChess) ⭐ 9 | 🐛 0 | 🌐 Ada | 📅 2023-11-09 - Chess engine written in Ada.
* [adage](https://github.com/atalii/adage) ⭐ 9 | 🐛 1 | 🌐 Ada | 📅 2025-04-26 - An Ada/SPARK alternative to sudo and doas.
