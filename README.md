...
* [fsf-gnat](https://github.com/alire-project/GNAT-FSF-builds/releases) ⭐ 56 | 🐛 10 | 🌐 Python | 📅 2026-05-07 - Free Software Foundation compiler for the Ada programming language which forms part of the GNU Compiler Collection. It supports all versions of the language, i.e. Ada 2022, Ada 2012, Ada 2005, Ada 95 and Ada 83.

#### MIT

* [hac](https://github.com/zertovitch/hac) ⭐ 164 | 🐛 7 | 🌐 Ada | 📅 2026-01-31 - The HAC Ada Compiler - a small, quick Ada compiler fully in Ada.
...
<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 507 | 🐛 56 | 🌐 Ada | 📅 2026-05-06
...
* [lea](https://github.com/zertovitch/lea) ⭐ 32 | 🐛 1 | 🌐 Ada | 📅 2026-05-01 - A Lightweight Editor for Ada, aims to provide an easy, script-world-like, "look & feel" for developing Ada projects of any size and level, while enabling access to full-scale development tools like GNAT. LEA includes HAC, the HAC Ada Compiler.
...
* [alire](https://github.com/alire-project/alire) ⭐ 384 | 🐛 351 | 🌐 Ada | 📅 2026-05-06 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
...
* [tada](https://github.com/tomekw/tada) ⭐ 20 | 🐛 0 | 🌐 Ada | 📅 2026-05-09 - An opinionated package management tool for Ada.
...
* [bb-runtimes](https://github.com/AdaCore/bb-runtimes) ⭐ 70 | 🐛 6 | 🌐 Ada | 📅 2026-05-08 - GNAT bare metal board support package (BSP).
...
* [hirtos](https://github.com/jgrivera67/HiRTOS) ⭐ 51 | 🐛 5 | 🌐 Ada | 📅 2026-01-29 - A high-integrity RTOS written in SPARK Ada.
* [havk](https://github.com/RavSS/HAVK) ⭐ 28 | 🐛 1 | 🌐 Ada | 📅 2021-05-28 - x86-64 security-focused OS being created with SPARK.
* [Straylight](https://github.com/ajxs/straylight) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2026-05-07 - A simple monolithic RISC-V operating system developed in Ada.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 453 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 32,860 | 🐛 18 | 🌐 C | 📅 2026-05-09).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 104 | 🐛 2 | 🌐 Nim | 📅 2026-05-10 - Roguelike in sky with a steampunk setting.
...
* [civ-klon](https://github.com/HonkiTonk/Civ-Klon) ⭐ 22 | 🐛 1 | 🌐 Ada | 📅 2026-04-29 - Civilization-style turn-based strategy game. Requires [asfml].
...
* [gade-sdl](https://github.com/ellamosi/gade-sdl) ⭐ 5 | 🐛 1 | 🌐 Ada | 📅 2026-04-14 - An SDL2 Game Boy emulation front end for [Gade](https://github.com/ellamosi/gade) ⭐ 32 | 🐛 14 | 🌐 Ada | 📅 2026-04-11 using [SDLAda](https://github.com/Lucretia/sdlada) ⭐ 133 | 🐛 24 | 🌐 Ada | 📅 2025-07-24.
...
* [gnatcoll-core](https://github.com/AdaCore/gnatcoll-core) ⭐ 54 | 🐛 14 | 🌐 Ada | 📅 2026-05-06 - This is the core module of the GNAT Components Collection.
...
* [gtkada](https://github.com/AdaCore/gtkada) ⭐ 104 | 🐛 39 | 🌐 Ada | 📅 2026-04-28 - Ada graphical toolkit based on Gtk3 components.
...
* [gwindows](https://github.com/zertovitch/gwindows) ⭐ 25 | 🐛 3 | 🌐 Ada | 📅 2026-05-09 - GNU Ada Visual Interface.
...
* [globe-3d](https://github.com/zertovitch/globe-3d) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2026-05-08 - GL Object Based Engine for 3D.
...
* [testy](https://github.com/tomekw/testy) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2026-05-07 - Ada testing framework, part of [Tada](https://github.com/tomekw/tada) ⭐ 20 | 🐛 0 | 🌐 Ada | 📅 2026-05-09.
...
* [septum](https://github.com/pyjarrett/septum) ⭐ 399 | 🐛 11 | 🌐 Ada | 📅 2026-05-09 - An interactive context-based text search tool for searching large codebases.
...
* [spark-2014](https://github.com/AdaCore/spark2014/) ⭐ 306 | 🐛 4 | 🌐 Ada | 📅 2026-05-07 - SPARK formal verification toolset.
...
* [ada-keystore](https://github.com/stcarrez/ada-keystore) ⭐ 36 | 🐛 3 | 🌐 Ada | 📅 2026-05-07 - Ada Keystore - protect your sensitive data with secure storage.
...
* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 294 | 🐛 59 | 🌐 Ada | 📅 2026-05-08 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
...
* [libadalang](https://github.com/AdaCore/libadalang/) ⭐ 169 | 🐛 21 | 🌐 Ada | 📅 2026-05-07 - Library for parsing and semantic analysis of Ada code. It is meant as a building block for integration into other tools (IDE, static analyzers, etc).
...
* [SweetAda](https://github.com/gabriele-galeotti/SweetAda) ⭐ 51 | 🐛 0 | 🌐 Ada | 📅 2026-05-09 - A lightweight development framework whose purpose is the implementation of Ada-based software systems. It supports a plethora or CPU architectures and development boards.
* [adamant](https://github.com/lasp/adamant) ⭐ 46 | 🐛 4 | 🌐 Ada | 📅 2026-05-05 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
...
* [ada-drivers-library](https://github.com/AdaCore/Ada_Drivers_Library) ⭐ 279 | 🐛 26 | 🌐 Ada | 📅 2026-05-08 - Ada drivers for various MCU and sensors.
...
* [azip](https://github.com/zertovitch/azip) ⭐ 16 | 🐛 1 | 🌐 Ada | 📅 2026-03-21 - A free, portable Zip Archive Manager.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,807 | 🐛 367 | 🌐 VHDL | 📅 2026-05-09 - VHDL 2008/93/87 simulator.
...
* [whitakers-words](https://github.com/mk270/whitakers-words) ⭐ 317 | 🐛 52 | 🌐 Ada | 📅 2025-01-21 - William Whitaker's WORDS, a Latin dictionary.
