...
* [crate-of-the-year](https://github.com/AdaCore/Ada-SPARK-Crate-Of-The-Year) ⭐ 23 | 🐛 0 | 📅 2025-11-18 - Yearly prize for the best Alire crate in three categories: general, SPARK and embedded.
...
* [fsf-gnat](https://github.com/alire-project/GNAT-FSF-builds/releases) ⭐ 56 | 🐛 10 | 🌐 Python | 📅 2026-04-21 - Free Software Foundation compiler for the Ada programming language which forms part of the GNU Compiler Collection. It supports all versions of the language, i.e. Ada 2022, Ada 2012, Ada 2005, Ada 95 and Ada 83.
...
<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 503 | 🐛 56 | 🌐 Ada | 📅 2026-04-21
...
* [lea](https://github.com/zertovitch/lea) ⭐ 31 | 🐛 1 | 🌐 Ada | 📅 2026-04-17 - A Lightweight Editor for Ada, aims to provide an easy, script-world-like, "look & feel" for developing Ada projects of any size and level, while enabling access to full-scale development tools like GNAT. LEA includes HAC, the HAC Ada Compiler.
...
* [alire](https://github.com/alire-project/alire) ⭐ 380 | 🐛 355 | 🌐 Ada | 📅 2026-04-21 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
...
* [ravenadm](https://github.com/jrmarino/ravenadm) ⭐ 21 | 🐛 12 | 🌐 Ada | 📅 2026-04-23 - Administration tool for Ravenports <http://www.ravenports.com>.
...
* [adawebpack](https://github.com/godunko/adawebpack) ⭐ 77 | 🐛 4 | 🌐 Ada | 📅 2025-02-16 - GNAT RTL for WebAssembly and bindings for Web API.
* [bb-runtimes](https://github.com/AdaCore/bb-runtimes) ⭐ 70 | 🐛 5 | 🌐 Ada | 📅 2026-04-16 - GNAT bare metal board support package (BSP).
...
* [Straylight](https://github.com/ajxs/straylight) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2026-04-16 - A simple monolithic RISC-V operating system developed in Ada.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 454 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 32,488 | 🐛 12 | 🌐 C | 📅 2026-04-24).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 104 | 🐛 2 | 🌐 Nim | 📅 2026-04-25 - Roguelike in sky with a steampunk setting.
...
* [gtkada](https://github.com/AdaCore/gtkada) ⭐ 103 | 🐛 39 | 🌐 Ada | 📅 2026-04-21 - Ada graphical toolkit based on Gtk3 components.
...
* [gwindows](https://github.com/zertovitch/gwindows) ⭐ 25 | 🐛 3 | 🌐 Ada | 📅 2026-04-17 - GNU Ada Visual Interface.
...
* [awa](https://github.com/stcarrez/ada-awa) ⭐ 110 | 🐛 10 | 🌐 Ada | 📅 2026-04-19 - Ada Web Application is a framework to build a Web Application in Ada 2012. The framework provides several ready to use and extendable modules that are common to many web application. This includes the login, authentication, users, permissions, managing comments, tags, votes, documents, images.
  ...
  * [ada-asf](https://github.com/stcarrez/ada-asf) ⭐ 15 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-18 - Ada Server Faces allows to create web applications using the same pattern as the Java Server Faces (See JSR 252, JSR 314 and JSR 344).
...
* [bbt](https://github.com/LionelDraghi/bbt) ⭐ 22 | 🐛 5 | 🌐 Ada | 📅 2026-04-24 - Simple tool to black box check the behavior of an executable through the command line.
...
* [spark-2014](https://github.com/AdaCore/spark2014/) ⭐ 304 | 🐛 4 | 🌐 Ada | 📅 2026-04-24 - SPARK formal verification toolset.
* [gnat-coverage](https://github.com/AdaCore/gnatcoverage) ⭐ 46 | 🐛 5 | 🌐 Ada | 📅 2026-04-24 - GNATcoverage is a tool to analyze and report program coverage.
...
* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 293 | 🐛 59 | 🌐 Ada | 📅 2026-04-24 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
...
* [libadalang](https://github.com/AdaCore/libadalang/) ⭐ 168 | 🐛 21 | 🌐 Ada | 📅 2026-04-22 - Library for parsing and semantic analysis of Ada code. It is meant as a building block for integration into other tools (IDE, static analyzers, etc).
...
* [protobuf](https://github.com/reznikmm/protobuf) ⭐ 45 | 🐛 11 | 🌐 Ada | 📅 2026-04-19 - A Google Protocol Buffers implementation in Ada, using [matreshka].
...
* [ada-pdf-writer](https://github.com/zertovitch/ada-pdf-writer) ⭐ 25 | 🐛 0 | 🌐 Ada | 📅 2026-02-16 - Ada package for producing easily and automatically PDF files, from an Ada program, with text, vector graphics, images (JPEG).
...
* [cuda](https://github.com/AdaCore/cuda) ⭐ 23 | 🐛 2 | 🌐 Ada | 📅 2024-09-10 - Support for CUDA (Compute Unified Device Architecture) from AdaCore.
...
* [SweetAda](https://github.com/gabriele-galeotti/SweetAda) ⭐ 51 | 🐛 0 | 🌐 Ada | 📅 2026-04-22 - A lightweight development framework whose purpose is the implementation of Ada-based software systems. It supports a plethora or CPU architectures and development boards.
* [adamant](https://github.com/lasp/adamant) ⭐ 45 | 🐛 4 | 🌐 Ada | 📅 2026-04-22 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
...
* [ada-drivers-library](https://github.com/AdaCore/Ada_Drivers_Library) ⭐ 279 | 🐛 27 | 🌐 Ada | 📅 2026-04-20 - Ada drivers for various MCU and sensors.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,801 | 🐛 363 | 🌐 VHDL | 📅 2026-04-22 - VHDL 2008/93/87 simulator.
...
* [whitakers-words](https://github.com/mk270/whitakers-words) ⭐ 314 | 🐛 52 | 🌐 Ada | 📅 2025-01-21 - William Whitaker's WORDS, a Latin dictionary.
