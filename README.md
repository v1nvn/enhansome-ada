...
* [hac](https://github.com/zertovitch/hac) ⭐ 158 | 🐛 7 | 🌐 Ada | 📅 2026-01-31 - The HAC Ada Compiler - a small, quick Ada compiler fully in Ada.
* [byron](https://github.com/OneWingedShark/Byron) ⭐ 64 | 🐛 0 | 🌐 Ada | 📅 2020-05-16 - A community project to build an Ada compiler, toolchain, and IDE-system.
...
<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 497 | 🐛 55 | 🌐 Ada | 📅 2026-03-16
...
* [lea](https://github.com/zertovitch/lea) ⭐ 30 | 🐛 1 | 🌐 Ada | 📅 2026-03-07 - A Lightweight Editor for Ada, aims to provide an easy, script-world-like, "look & feel" for developing Ada projects of any size and level, while enabling access to full-scale development tools like GNAT. LEA includes HAC, the HAC Ada Compiler.
...
* [alire](https://github.com/alire-project/alire) ⭐ 371 | 🐛 354 | 🌐 Ada | 📅 2026-03-13 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
* [synth](https://github.com/jrmarino/synth) ⭐ 267 | 🐛 11 | 🌐 Ada | 📅 2026-02-14 - Next D/Ports build tool for live systems (Alternative for Portmaster and Portupgrade tools).
* [gprbuild](https://github.com/AdaCore/gprbuild) ⭐ 79 | 🐛 37 | 🌐 Ada | 📅 2026-01-22 - Adacore multi-language software build tool.
...
* [ravenadm](https://github.com/jrmarino/ravenadm) ⭐ 21 | 🐛 11 | 🌐 Ada | 📅 2026-02-27 - Administration tool for Ravenports <http://www.ravenports.com>.
* [tada](https://github.com/tomekw/tada) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2026-03-12 - An opinionated package management tool for Ada.
...
* [adawebpack](https://github.com/godunko/adawebpack) ⭐ 76 | 🐛 4 | 🌐 Ada | 📅 2025-02-16 - GNAT RTL for WebAssembly and bindings for Web API.
* [bb-runtimes](https://github.com/AdaCore/bb-runtimes) ⭐ 69 | 🐛 5 | 🌐 Ada | 📅 2026-02-25 - GNAT bare metal board support package (BSP).
...
* [cubit](https://github.com/docandrew/CuBit) ⭐ 86 | 🐛 4 | 🌐 Ada | 📅 2026-03-14 - CuBitOS is a multi-processor, 64-bit, (partially) formally-verified, general-purpose operating system, currently for the x86-64 architecture.
...
* [hirtos](https://github.com/jgrivera67/HiRTOS) ⭐ 46 | 🐛 5 | 🌐 Ada | 📅 2026-01-29 - A high-integrity RTOS written in SPARK Ada.
* [havk](https://github.com/RavSS/HAVK) ⭐ 27 | 🐛 1 | 🌐 Ada | 📅 2021-05-28 - x86-64 security-focused OS being created with SPARK.
* [Straylight](https://github.com/ajxs/straylight) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2026-02-21 - A simple monolithic RISC-V operating system developed in Ada.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 448 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 31,542 | 🐛 1 | 🌐 C | 📅 2026-03-15).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 101 | 🐛 2 | 🌐 Nim | 📅 2026-03-16 - Roguelike in sky with a steampunk setting.
* [gade](https://github.com/ellamosi/gade) ⭐ 29 | 🐛 12 | 🌐 Ada | 📅 2026-03-16 - A Game Boy emulation library in Ada.
...
* [civ-klon](https://github.com/HonkiTonk/Civ-Klon) ⭐ 21 | 🐛 1 | 🌐 Ada | 📅 2026-03-05 - Civilization-style turn-based strategy game. Requires [asfml].
...
* [gade-sdl](https://github.com/ellamosi/gade-sdl) ⭐ 0 | 🐛 1 | 🌐 Ada | 📅 2026-03-14 - An SDL2 Game Boy emulation front end for [Gade](https://github.com/ellamosi/gade) ⭐ 29 | 🐛 12 | 🌐 Ada | 📅 2026-03-16 using [SDLAda](https://github.com/Lucretia/sdlada) ⭐ 129 | 🐛 24 | 🌐 Ada | 📅 2025-07-24.
...
* [gnatcoll-bindings](https://github.com/AdaCore/gnatcoll-bindings) ⭐ 16 | 🐛 6 | 🌐 Ada | 📅 2026-02-11 - This is the bindings module of the GNAT Components Collection.
...
* [poly-orb](https://github.com/AdaCore/PolyORB) ⭐ 23 | 🐛 4 | 🌐 Ada | 📅 2026-02-17 - PolyORB provides a uniform solution to build distributed applications relying either on middleware standards.

### Graphical User Interface

* [gtkada](https://github.com/AdaCore/gtkada) ⭐ 103 | 🐛 39 | 🌐 Ada | 📅 2026-03-06 - Ada graphical toolkit based on Gtk3 components.
* [ada-gui](https://github.com/jrcarter/Ada_GUI) ⭐ 45 | 🐛 1 | 🌐 Ada | 📅 2025-06-20 - GUI implemented on its own task, so it doesn't require that its client give up a thread of control. Derived from [gnoga].
* [gwindows](https://github.com/zertovitch/gwindows) ⭐ 25 | 🐛 3 | 🌐 Ada | 📅 2026-03-03 - GNU Ada Visual Interface.
...
* [ada-doom-3](https://github.com/AdaDoom3/AdaDoom3) ⭐ 277 | 🐛 8 | 🌐 Ada | 📅 2023-03-29 - Id Software's Id-tech-4-BFG in the Ada programming language.
...
* [aws](https://github.com/AdaCore/aws) ⭐ 152 | 🐛 36 | 🌐 Ada | 📅 2026-03-12 - Ada Web Server is a complete framework to develop Web based applications in Ada.

<!--lint enable awesome-list-item-->

* [awa](https://github.com/stcarrez/ada-awa) ⭐ 107 | 🐛 10 | 🌐 Ada | 📅 2026-03-15 - Ada Web Application is a framework to build a Web Application in Ada 2012. The framework provides several ready to use and extendable modules that are common to many web application. This includes the login, authentication, users, permissions, managing comments, tags, votes, documents, images.
  ...
  * [ada-wiki](https://github.com/stcarrez/ada-wiki) ⭐ 20 | 🐛 4 | 🌐 Ada | 📅 2026-03-07 - Ada Wiki is a small library that provides a Wiki engine.
  ...
  * [ada-asf](https://github.com/stcarrez/ada-asf) ⭐ 14 | 🐛 3 | 🌐 Ada | 📅 2026-03-07 - Ada Server Faces allows to create web applications using the same pattern as the Java Server Faces (See JSR 252, JSR 314 and JSR 344).
...
* [bbt](https://github.com/LionelDraghi/bbt) ⭐ 18 | 🐛 5 | 🌐 Ada | 📅 2026-03-12 - Simple tool to black box check the behavior of an executable through the command line.
* [aunit](https://github.com/AdaCore/aunit) ⭐ 11 | 🐛 17 | 🌐 Ada | 📅 2026-03-10 - Ada unit testing framework.
...
* [testy](https://github.com/tomekw/testy) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2026-03-12 - Ada testing framework, part of [Tada](https://github.com/tomekw/tada) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2026-03-12.
...
* [septum](https://github.com/pyjarrett/septum) ⭐ 396 | 🐛 15 | 🌐 Ada | 📅 2026-02-26 - An interactive context-based text search tool for searching large codebases.
* [powerjoular](https://github.com/joular/powerjoular) ⭐ 102 | 🐛 10 | 🌐 Ada | 📅 2026-02-13 - This tool allows monitoring power consumption of multiple platforms and processes.
...
* [spark-2014](https://github.com/AdaCore/spark2014/) ⭐ 298 | 🐛 4 | 🌐 Ada | 📅 2026-03-13 - SPARK formal verification toolset.
* [gnat-coverage](https://github.com/AdaCore/gnatcoverage) ⭐ 46 | 🐛 5 | 🌐 Ada | 📅 2026-03-16 - GNATcoverage is a tool to analyze and report program coverage.
...
* [record-flux](https://github.com/Componolit/RecordFlux) ⭐ 123 | 🐛 186 | 🌐 Ada | 📅 2026-01-07 - RecordFlux: Toolset for the formal specification of messages and the generation of verifiable binary parsers and message generators in SPARK.
...
* [ada-keystore](https://github.com/stcarrez/ada-keystore) ⭐ 36 | 🐛 5 | 🌐 Ada | 📅 2026-03-06 - Ada Keystore - protect your sensitive data with secure storage.
...
* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 289 | 🐛 58 | 🌐 Ada | 📅 2026-03-16 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
...
* [simple-blockchain](https://github.com/tomekw/simple_blockchain) ⭐ 22 | 🐛 0 | 🌐 Ada | 📅 2025-09-11 - Simple blockchain in Ada.
...
* [spark-nacl](https://github.com/rod-chapman/SPARKNaCl) ⭐ 132 | 🐛 4 | 🌐 Ada | 📅 2025-03-17 - SPARK 2014 re-implementation of the TweetNaCl crypto library.
...
* [libkeccak](https://github.com/damaki/libkeccak) ⭐ 37 | 🐛 1 | 🌐 Ada | 📅 2023-10-19 - A SPARK implementation of the Keccak family of sponge functions and related constructions.
* [libsparkcrypto](https://github.com/Componolit/libsparkcrypto) ⚠️ Archived - A cryptographic library implemented in SPARK.
* [libsodium-ada](https://github.com/jrmarino/libsodium-ada) ⭐ 11 | 🐛 1 | 🌐 Ada | 📅 2016-07-18 - A secure cryptographic library (libsodium for Ada).
...
* [zip-ada](https://github.com/zertovitch/zip-ada) ⭐ 33 | 🐛 1 | 🌐 Ada | 📅 2026-03-14 - Programming library for dealing with the Zip compressed archive file format.
...
* [libadalang](https://github.com/AdaCore/libadalang/) ⭐ 164 | 🐛 21 | 🌐 Ada | 📅 2026-03-11 - Library for parsing and semantic analysis of Ada code. It is meant as a building block for integration into other tools (IDE, static analyzers, etc).
...
* [template-parser](https://github.com/AdaCore/templates-parser) ⭐ 9 | 🐛 1 | 🌐 Ada | 📅 2026-01-09 - AWS templates engine.
...
* [ada-bfd](https://github.com/stcarrez/ada-bfd) ⭐ 8 | 🐛 1 | 🌐 Ada | 📅 2025-11-02 - An Ada binding for the GNU Binutils BFD library. It allows to read binary ELF, COFF files by using the GNU BFD.
...
* [simple-logging](https://github.com/alire-project/simple_logging) ⭐ 4 | 🐛 1 | 🌐 Ada | 📅 2026-02-28 - Easy to use logging facilities for output to console in Ada programs.
...
* [florist](https://github.com/AdaCore/florist/) ⭐ 7 | 🐛 9 | 🌐 Ada | 📅 2026-01-06 - POSIX Ada binding, IEEE Standards 1003.5(b,c).
...
* [wposix](https://github.com/AdaCore/wposix) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2026-01-09 - Ada Windows POSIX binding.
...
* [SweetAda](https://github.com/gabriele-galeotti/SweetAda) ⭐ 50 | 🐛 0 | 🌐 Ada | 📅 2026-03-13 - A lightweight development framework whose purpose is the implementation of Ada-based software systems. It supports a plethora or CPU architectures and development boards.
* [adamant](https://github.com/lasp/adamant) ⭐ 42 | 🐛 3 | 🌐 Ada | 📅 2026-03-11 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
...
* [ada-drivers-library](https://github.com/AdaCore/Ada_Drivers_Library) ⭐ 276 | 🐛 23 | 🌐 Ada | 📅 2026-01-04 - Ada drivers for various MCU and sensors.
...
* [svd2ada](https://github.com/AdaCore/svd2ada) ⭐ 70 | 🐛 19 | 🌐 Ada | 📅 2025-02-13 - An Ada binding generator from SVD descriptions for bare board ARM devices.
...
* [cbsg](https://github.com/zertovitch/cbsg) ⭐ 14 | 🐛 0 | 🌐 Ada | 📅 2026-03-09 - The Corporate Bullshit Generator.
...
* [blackvideo-mini-player](https://github.com/BlackBlazent/blackvideo-mini-player) ⭐ 2 | 🐛 12 | 🌐 Ada | 📅 2026-03-14 - A stand-alone lightweight auxiliary video player support for [`BlackVideo`](https://github.com/BlackBlazent/BlackVideo) ⭐ 1 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-15.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,768 | 🐛 362 | 🌐 VHDL | 📅 2026-03-15 - VHDL 2008/93/87 simulator.
...
* [pascal-to-ada](https://github.com/zertovitch/pascal-to-ada) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2024-10-20 - A Pascal to Ada translator.
  * [tp7-ada-gnoga](https://github.com/Blady-Com/tp7ada-gnoga) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2026-03-09 - Implementation of Turbo Pascal 7.0 units with [gnoga].
...
* [gsh](https://github.com/AdaCore/gsh) ⭐ 119 | 🐛 12 | 🌐 C | 📅 2023-07-22 - Non interactive POSIX shell for Windows, aimed at GNU software builds. 2-3 times faster than Cygwin.
* [dashera](https://github.com/SMerrony/dashera) ⚠️ Archived - Data General DASHER terminal emulator using [gtkada].
* [a-shell](https://github.com/charlie5/aShell) ⭐ 17 | 🐛 1 | 🌐 Ada | 📅 2025-11-04 - A component to aid in writing shell-like applications in Ada.
...
* [whitakers-words](https://github.com/mk270/whitakers-words) ⭐ 312 | 🐛 50 | 🌐 Ada | 📅 2025-01-21 - William Whitaker's WORDS, a Latin dictionary.
