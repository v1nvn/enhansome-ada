...
<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 496 | 🐛 53 | 🌐 Ada | 📅 2026-03-09
...
* [lea](https://github.com/zertovitch/lea) ⭐ 28 | 🐛 1 | 🌐 Ada | 📅 2026-03-07 - A Lightweight Editor for Ada, aims to provide an easy, script-world-like, "look & feel" for developing Ada projects of any size and level, while enabling access to full-scale development tools like GNAT. LEA includes HAC, the HAC Ada Compiler.
...
* [alire](https://github.com/alire-project/alire) ⭐ 370 | 🐛 355 | 🌐 Ada | 📅 2026-02-28 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
...
* [tada](https://github.com/tomekw/tada) ⭐ 19 | 🐛 1 | 🌐 Ada | 📅 2026-03-09 - An opinionated package management tool for Ada.
...
* [cubit](https://github.com/docandrew/CuBit) ⭐ 86 | 🐛 4 | 🌐 Ada | 📅 2026-03-03 - CuBitOS is a multi-processor, 64-bit, (partially) formally-verified, general-purpose operating system, currently for the x86-64 architecture.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 447 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 31,461 | 🐛 1 | 🌐 C | 📅 2026-03-09).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 101 | 🐛 2 | 🌐 Nim | 📅 2026-03-09 - Roguelike in sky with a steampunk setting.
...
* [bbt](https://github.com/LionelDraghi/bbt) ⭐ 18 | 🐛 5 | 🌐 Ada | 📅 2026-03-06 - Simple tool to black box check the behavior of an executable through the command line.
...
* [spark-2014](https://github.com/AdaCore/spark2014/) ⭐ 297 | 🐛 4 | 🌐 Ada | 📅 2026-03-09 - SPARK formal verification toolset.
* [gnat-coverage](https://github.com/AdaCore/gnatcoverage) ⭐ 46 | 🐛 5 | 🌐 Ada | 📅 2026-03-10 - GNATcoverage is a tool to analyze and report program coverage.
...
* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 288 | 🐛 58 | 🌐 Ada | 📅 2026-03-05 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
...
* [florist](https://github.com/AdaCore/florist/) ⭐ 8 | 🐛 9 | 🌐 Ada | 📅 2026-01-06 - POSIX Ada binding, IEEE Standards 1003.5(b,c).
...
* [adamant](https://github.com/lasp/adamant) ⭐ 42 | 🐛 4 | 🌐 Ada | 📅 2026-03-04 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,766 | 🐛 365 | 🌐 VHDL | 📅 2026-03-08 - VHDL 2008/93/87 simulator.
